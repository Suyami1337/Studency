  ...
  return (
    <div>
      ...
      <AiAssistantOverlay
        ...
        initialMessages={[{ from: 'ai', text: `Привет! Я помогу с лендингом «${landing.name}». Могу написать заголовок, добавить секцию, переписать оффер или предложить структуру. Что делаем?` }]}
      />
