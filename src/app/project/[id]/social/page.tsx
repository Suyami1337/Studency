  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">Аналитика контента и подписчиков по всем площадкам в одном месте</p>
      </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold text-gray-900">Подключённые Telegram-каналы</h2>
          <p className="text-xs text-gray-500 mt-0.5">Клик по карточке — детальная аналитика канала и настройки</p>
        </div>
        <button
