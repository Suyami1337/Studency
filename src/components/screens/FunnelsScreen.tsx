      ...
      {loading ? (
        ...
        <>
          ...
          <AiAssistantOverlay
            ...
            initialMessages={[{ from: 'ai', text: 'Привет! Помогу настроить воронку. Что делаем — предложить этапы, тексты сообщений, идеи для догрева, или переписать что-то конкретное?' }]}
          />
