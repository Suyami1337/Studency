      ...
      {loading ? (
        ...
        <>
          ...
          <AiAssistantOverlay
            ...
            placeholder="Что улучшить в воронке..."
            context="Ты помогаешь настроить маркетинговую воронку (источники трафика → подписка на канал → запуск бота → лендинг → оплата). Пользователь может попросить предложить этапы, тексты сообщений, CTA, тарифы, идеи догрева. Отвечай конкретными шагами и текстами. Пользователь — маркетолог, не разработчик."
            initialMessages={[{ kind: 'ai' as const, text: 'Привет! Помогу настроить воронку. Что делаем — предложить этапы, тексты сообщений, идеи для догрева, или переписать что-то конкретное?' }]}
          />
